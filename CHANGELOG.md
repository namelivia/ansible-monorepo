...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.24.415 to 0.24.425
 - Upgrade grafana/grafana from 12.4.0-19877932531 to 12.4.0-20047394513
 - Upgrade library/ghost from 6.10.0 to 6.10.1
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.24.404 to 0.24.408
 - Upgrade library/ghost from 6.9.3 to 6.10.0

## [2.372.0] - 2025-12-05

### Changed

 - Upgrade linuxserver/jackett from 0.24.399 to 0.24.404
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.24.394 to 0.24.399
 - Upgrade ghcr.io/mealie-recipes/mealie from 3.6.0 to 3.6.1
 - Upgrade grafana/grafana from 12.4.0-19842126546 to 12.4.0-19877932531
 - Upgrade prom/prometheus from 3.7.3 to 3.8.0
...
### Changed
 ...
 - Upgrade caronc/apprise from 1.2.2 to 1.2.5
 - Upgrade linuxserver/jackett from 0.24.338 to 0.24.348

## [2.365.0] - 2025-11-21

### Changed

 - Upgrade linuxserver/jackett from 0.24.336 to 0.24.338
 - Upgrade library/nextcloud from 32.0.1 to 32.0.2

## [2.364.0] - 2025-11-20

### Changed

 - Upgrade linuxserver/jackett from 0.24.294 to 0.24.336
 - Upgrade fireflyiii/core from 6.4.7 to 6.4.8
 - Upgrade linuxserver/radarr from 6.0.4 to 6.1.0
 - Upgrade library/redis from 8.2.2 to 8.4.0
 - Upgrade linuxserver/lidarr from 3.0.1 to 3.1.0
 - Upgrade ghcr.io/immich-app/immich-server from 2.2.3 to 2.3.1
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 2.2.3 to 2.3.1
 - Upgrade library/ghost from 6.7.0 to 6.8.1

## [2.363.0] - 2025-11-17

### Changed

 - Upgrade ghcr.io/mealie-recipes/mealie from 3.4.0 to 3.5.0

## [2.362.0] - 2025-11-12

### Changed

 - Upgrade linuxserver/jackett from 0.24.275 to 0.24.294
 - Upgrade fireflyiii/core from 6.4.6 to 6.4.7
 - Upgrade grafana/grafana from 12.3.0-19020365962 to 12.4.0-19274378403
...
### Changed
 ...
 - Upgrade ghcr.io/karakeep-app/karakeep from 0.27.1 to 0.28.0
 - Upgrade linuxserver/jackett from 0.24.262 to 0.24.268
 - Upgrade fireflyiii/core from 6.4.5 to 6.4.6
 - Upgrade deluan/navidrome from 0.58.0 to 0.58.5

## [2.359.0] - 2025-11-08

### Changed

 - Upgrade linuxserver/jackett from 0.24.252 to 0.24.262
 - Upgrade fireflyiii/core from 6.4.4 to 6.4.5

## [2.358.0] - 2025-11-06

### Changed

 - Upgrade linuxserver/jackett from 0.24.250 to 0.24.252
 - Upgrade ghcr.io/immich-app/immich-server from 2.2.2 to 2.2.3
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 2.2.2 to 2.2.3
 - Upgrade grafana/loki from 3.5.7 to 3.5.8
 - Upgrade library/ghost from 6.6.0 to 6.6.1
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.24.234 to 0.24.241
 - Upgrade ghcr.io/mealie-recipes/mealie from 3.3.2 to 3.4.0
 - Upgrade fireflyiii/core from 6.4.3 to 6.4.4
 - Upgrade ghcr.io/immich-app/immich-server from 2.2.0 to 2.2.1
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 2.2.0 to 2.2.1

## [2.354.0] - 2025-10-31

### Changed

 - Upgrade linuxserver/jackett from 0.24.222 to 0.24.234
 - Upgrade fireflyiii/core from 6.4.2 to 6.4.3
 - Upgrade linuxserver/lidarr from 2.14.5 to 3.0.1
 - Upgrade ghcr.io/immich-app/immich-server from 2.1.0 to 2.2.0
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 2.1.0 to 2.2.0

## [2.353.0] - 2025-10-30

### Changed

 - Upgrade linuxserver/jackett from 0.24.200 to 0.24.222
 - Upgrade grafana/grafana from 12.3.0-18765596677 to 12.3.0-18925857539
 - Upgrade prom/prometheus from 3.7.2 to 3.7.3
 - Upgrade ngosang/amule from 2.3.3-19 to 2.3.3-20

## [2.352.0] - 2025-10-28

### Changed

 - Upgrade linuxserver/jackett from 0.24.191 to 0.24.200
 - Upgrade grafana/alloy from 1.11.2 to 1.11.3
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.24.90 to 0.24.95
...
### Added
 ...
 - Include a second copy of mealie in the latest version
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.2217 to 0.22.2223
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.2178 to 0.22.2187
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.1867 to 0.22.1874
...
### Changed
 ...
 - Upgrade gcr.io/cadvisor/cadvisor from 0.51.0 to 0.52.1
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.1437 to 0.22.1438
...
### Changed
 ...
 - Upgrade caronc/apprise from 1.1.6 to 1.1.7
...
### Changed
 ...
 - Downgrade namelivia/garments-server from 2.0.1 to 1.6.0
...
### Fixed
 ...
 - Increase memory for garments server
...
### Changed
 ...
 - Fix immich 1.118.0 breaking changes
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.694 to 0.22.698
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.655 to 0.22.656
...
### Changed
 ...
 - Upgrade library/ghost from 5.89.6 to 5.90.0

## [2.57.0] - 2024-08-22

### Changed

 - Upgrade library/nextcloud from 29.0.4 to 29.0.5
 - Upgrade library/ghost from 5.89.5 to 5.89.6

## [2.56.0] - 2024-08-21

### Changed

 - Upgrade linuxserver/jackett from 0.22.470 to 0.22.497
 - Upgrade linuxserver/radarr from 5.9.1 to 5.10.0
 - Upgrade library/ghost from 5.89.3 to 5.89.5

## [2.55.0] - 2024-08-19

### Changed

 - Upgrade linuxserver/radarr from 5.9.0 to 5.9.1
 - Upgrade miniflux/miniflux from 2.1.4 to 2.2.0

## [2.54.0] - 2024-08-18

### Changed

 - Upgrade linuxserver/jackett from 0.22.468 to 0.22.470

## [2.53.0] - 2024-08-17

### Changed

 - Upgrade linuxserver/jackett from 0.22.457 to 0.22.468
 - Upgrade library/ghost from 5.89.1 to 5.89.3

## [2.52.0] - 2024-08-16

### Changed

 - Upgrade linuxserver/jackett from 0.22.450 to 0.22.457
...
### Fixed
 ...
 - Use my own fork of docker-pleroma

## [2.51.0] - 2024-08-15

### Changed

 - Upgrade linuxserver/jackett from 0.22.439 to 0.22.450
 - Upgrade grafana/grafana from 11.1.1 to 11.1.4
 - Upgrade ghcr.io/immich-app/immich-server from 1.111.0 to 1.112.1
 - Upgrade ghcr.io/immich-app/immich-server from 1.111.0 to 1.112.1
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 1.111.0 to 1.112.1

## [2.50.13] - 2024-08-13

### Fixed

 - Remove bridge network from containers

## [2.50.12] - 2024-08-13

### Fixed

 - Add more missing network
...
### Fixed
 ...
 - Add network for dashy

## [2.50.8] - 2024-08-13

### Fixed

 - Add prometheus network to grafana

## [2.50.7] - 2024-08-13

### Fixed

 - Remove hardcoded networks

## [2.50.6] - 2024-08-13

### Fixed

 - Add loki network name to grafana

## [2.50.5] - 2024-08-13

### Fixed

 - Add database network name to grafana

## [2.50.4] - 2024-08-13

### Fixed

 - Create its own network for pleroma

## [2.50.3] - 2024-08-13

### Fixed

 - Add more database network parameters
...
### Fixed
 ...
 - Add network for redis container

## [2.50.0] - 2024-08-13

### Changed

 - Upgrade linuxserver/jackett from 0.22.436 to 0.22.439
 - Upgrade library/ghost from 5.89.0 to 5.89.1
...
### Fixed
 ...
 - Fix networking for gallery containers

## [2.49.14] - 2024-08-13

### Fixed

 - Fix networking for more containers

## [2.49.13] - 2024-08-13

### Fixed

 - Add database network name parameter to user info service

## [2.49.12] - 2024-08-13

### Fixed

 - Fix networking for user info service

## [2.49.11] - 2024-08-13

### Fixed

 - Add networks and network parameteres to some apps

## [2.49.10] - 2024-08-13

### Fixed

 - Add database network param to journaling service
...
### Fixed
 ...
 - Add networks to some service provider containers

## [2.49.7] - 2024-08-12

### Fixed

 - Add database network param to nextcloud

## [2.49.6] - 2024-08-12

### Fixed

 - Add vpn network param to pomerium

## [2.49.5] - 2024-08-12

### Fixed

 - Add more networks to apps

## [2.49.4] - 2024-08-12

### Fixed

 - Add network to tombraiderjs
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.432 to 0.22.436

## [2.48.1] - 2024-08-10

### Fixed

 - Use x-systemd.automount option for Samba shares

## [2.48.0] - 2024-08-10

### Changed

 - Upgrade linuxserver/jackett from 0.22.411 to 0.22.432
 - Upgrade prom/prometheus from 2.53.1 to 2.53.2

## [2.47.0] - 2024-08-09

### Changed

 - Upgrade linuxserver/jackett from 0.22.411 to 0.22.420
 - Upgrade grafana/loki from 3.1.0 to 3.1.1

## [2.46.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.110.0 to 1.111.0

## [2.45.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.109.2 to 1.110.0

## [2.44.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.109.0 to 1.109.2

## [2.43.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.108.0 to 1.109.0

## [2.42.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.107.2 to 1.108.0

## [2.41.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.106.3 to 1.107.2

## [2.40.0] - 2024-08-08

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.106.3 to 1.106.4

## [2.39.0] - 2024-08-08

### Changed

 - Downgrade ghcr.io/immich-app/immich-server from 1.111.0 to 1.106.3

## [2.38.0] - 2024-08-06

### Changed

 - Upgrade lscr.io/linuxserver/babybuddy from 2.2.1 to 2.5.0

## [2.37.0] - 2024-08-06

### Changed

 - Upgrade gcr.io/cadvisor/cadvisor from 0.49.1 to 0.50.0

## [2.36.0] - 2024-08-06

### Changed

 - Upgrade ghcr.io/immich-app/immich-server from 1.106.3 to 1.111.0
 - Upgrade ghcr.io/immich-app/immich-server from 1.106.3 to 1.111.0
 - Upgrade ghcr.io/immich-app/immich-machine-learning from 1.106.3 to 1.111.0

## [2.35.0] - 2024-08-06

### Changed

 - Upgrade linuxserver/jackett from 0.22.410 to 0.22.411
 - Upgrade library/ghost from 5.88.3 to 5.89.0

## [2.34.1] - 2024-08-06

### Changed

 - Set alexta/metube tag from latest to 2024-08-02

## [2.34.0] - 2024-08-05

### Changed

 - Upgrade linuxserver/jackett from 0.22.409 to 0.22.410

## [2.33.0] - 2024-08-04

### Changed

 - Upgrade linuxserver/jackett from 0.22.402 to 0.22.409
...
### Changed
 ...
 - Downgrade linuxserver/lidarr from 2.5.0-develop to 2.4.3
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.388 to 0.22.391

## [2.29.0] - 2024-07-28

### Changed

 - Upgrade caronc/apprise from 1.1.4 to 1.1.5
 - Upgrade linuxserver/jackett from 0.22.364 to 0.22.388

## [2.28.0] - 2024-07-25

### Changed

 - Upgrade linuxserver/jackett from 0.22.361 to 0.22.364
 - Upgrade grafana/grafana from 11.1.0 to 11.1.1-ubuntu

## [2.27.1] - 2024-07-23

### Changed

 - Fixed library/nextcloud from 29.0.4-fpm to 29.0.4
...
### Changed
 ...
 - Upgrade linuxserver/jackett from 0.22.344 to 0.22.353

## [2.25.0] - 2024-07-20

### Changed

 - Upgrade linuxserver/lidarr from 2.4.0 to 2.4.3
...
### Changed
 ...
 - Upgrade Jackett from 0.22.288 to 0.22.326
 - Upgrade Prometheus from 2.53.0 to 2.53.1
 - Upgrade Miniflux from 2.1.3 to 2.1.4
 - Upgrade Ghost from 5.87.1 to 5.87.2

## [2.21.0] - 2024-07-07

### Changed

 - Upgrade Jackett from 0.22.263 to 0.22.288
 - Upgrade Ghost from 5.87.0 to 5.87.1
...
### Added
 ...
 - Added simple role to serve static files using Nginx.
...
### Changed
 ...
 - Upgrade Jackett from 0.22.154 to 0.22.179
 - Upgrade Firefly III from 6.1.17 to 6.1.18
 - Upgrade Nextcloud from 29.0.1 to 29.0.2
...
### Changed
 ...
 - Upgrade Jackett from 0.22.136 to 0.22.154
 - Upgrade Kimai from 2.17.0 to 2.18.0

## [2.10.0] - 2024-06-16

### Changed

 - Upgrade Jackett from 0.22.112 to 0.22.136
 - Upgrade Firefly III from 6.1.16 to 6.1.17
...
### Changed
 ...
 - Upgrade Garments Server from 1.4.0 to 1.5.0
 - Upgrade Ghost from 5.84.2 to 5.85.0
 - Upgrade Jackett from 0.22.84 to 0.22.112
 - Upgrade Pomerium from 0.25.2 to 0.26.0
 - Upgrade Prometheus from 2.53.0-rc.0 to 2.53.0-rc.1
...
### Changed
 ...
 - Upgrade Garments Server from 1.0.1 to 1.1.0

## [2.3.1] - 2024-06-08

### Changed

 - Upgrade Garments Server from 1.0.1 to 1.0.3

## [2.3.0] - 2024-06-08

### Changed

 - Set Garments Server tag to 1.0.1

## [2.2.0] - 2024-06-07 

### Changed

 - Upgrade Jackett from 0.22.43 to 0.22.84
 - Upgrade Ghost from 5.83.0 to 5.84.2
...
### Changed
 ...
 - Allow multiple Samba shares

## [1.8.0] - 2024-06-03

### Changed

 - Upgrade Bazarr from 1.4.2 to 1.4.3
 - Upgrade Jackett from 0.21.2855 to 0.22.43
 - Upgrade Nextcloud from 29.0.0 to 29.0.1
 - Upgrade Ghost from 5.82.12 to 5.83.0
 - Downgrade Ofelia from 3.0.8 to 0.3.12
...
### Changed
 ...
 - Disable pg_dump backups for Pleroma.

## [1.5.1] - 2024-05-22

### Changed

 - Upgrade Plants server from latest to 1.0.1

## [1.5.0] - 2024-05-22

### Changed

 - Upgrade Plants server from latest to 1.0.0

## [1.4.1] - 2024-05-21

### Changed

 - Add --retry-lock 5m to all restic commands.

## [1.4.0] - 2024-05-21

### Changed

 - Upgrade Jackett from 0.21.2644 to 0.21.2652
 - Upgrade Kimai from 2.16.1 to 2.17.0
 - Upgrade Redis from 7.2.4 to 7.2.5

## [1.3.2] - 2024-05-20

### Changed

 - Fix restic script path issues.

## [1.3.1] - 2024-05-20

### Changed

 - Add --force flag to the migrate command in firefly.

## [1.3.0] - 2024-05-20

### Changed

 - Upgrade Firefly from 6.1.15 to 6.1.16
 - Upgrade Jackett from 0.21.2628 to 0.21.2644

## [1.2.2] - 2024-05-19

### Changed

 - Improve restic observability

## [1.2.1] - 2024-05-18

### Changed

 - Downgrade Pomerium from 0.26.0 to 0.25.2

## [1.2.0] - 2024-05-18

### Changed

 - Upgrade Jackett from 0.21.2606 to 0.21.2628
 - Upgrade Pomerium from 0.25.2 to 0.26.0
 - Upgrade Ghost from 5.82.2-alpine to 5.82.11-alpine
 - Set Loki tag to 3.0.0

## [1.1.1] - 2024-05-18

### Changed

 - Set pleroma to stable branch

## [1.1.0] - 2024-05-17

### Changed

 - Upgrade Grafana from 10.4.2 to 11.0.0
 - Upgrade Jackett from 0.21.2592 to 0.21.2606
 - Upgrade Nextcloud from 28.0.5 to 29.0.0
 - Upgrade Radarr from 5.6.0-nightly to 5.7.0-nightly
